rootProject.name = "spring-kotlin-jpa"
...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            val springKotlinErrorVersion: String by System.getProperties()
            version("spring-kotlin-error", springKotlinErrorVersion)
            library("spring-kotlin-error", "dev.mbo", "spring-kotlin-error")
                .versionRef("spring-kotlin-error")
        }
    }
}